...
public class AlgorithmTestFixture6 extends AbstractAlgorithmTestFixture {

    public AlgorithmTestFixture6() throws CouldNotReceiveResultException {
        this.columnNames = ImmutableList.of("A", "B", "C");
        this.numberOfColumns = 3;
        this.table.add(GenericRow.ofColumnNames(columnNames, "1", "2", "5"));
        this.table.add(GenericRow.ofColumnNames(columnNames, "2", "3", "4"));
        this.table.add(GenericRow.ofColumnNames(columnNames, "2", "3", "4"));
        this.table.add(GenericRow.ofColumnNames(columnNames, "3", "5", "5"));
        this.table.add(GenericRow.ofColumnNames(columnNames, "4", "3", "5"));
