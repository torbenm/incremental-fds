...
public class AlgorithmTestFixture7 extends AbstractAlgorithmTestFixture {
    ...
    public AlgorithmTestFixture7() throws CouldNotReceiveResultException {
        ...
        this.table.add(GenericRow.ofColumnNames(columnNames, "2", "2", "4"));
        this.table.add(GenericRow.ofColumnNames(columnNames, "3", "3", "4"));
        this.table.add(GenericRow.ofColumnNames(columnNames, "4", "3", "4"));
