...
public class AlgorithmTestFixture9 extends AbstractAlgorithmTestFixture {

    public AlgorithmTestFixture9() throws CouldNotReceiveResultException {
        this.columnNames = ImmutableList.of("A", "B", "C");
        this.numberOfColumns = 3;
        this.table.add(GenericRow.ofColumnNames(columnNames, "2", "1", "1"));
        this.table.add(GenericRow.ofColumnNames(columnNames, "1", "2", "2"));
        this.table.add(GenericRow.ofColumnNames(columnNames, "2", "2", "3"));
    }
